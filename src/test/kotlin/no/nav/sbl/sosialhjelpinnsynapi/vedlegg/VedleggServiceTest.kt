...
internal class VedleggServiceTest {
    ...
    fun `skal hente alle vedlegg for digisosSak`() {
        ...
        assertThat(list[2].beskrivelse).isEqualTo(dokumenttype)
        ...
        assertThat(list[3].beskrivelse).isEqualTo(dokumenttype)
        ...
        assertThat(list[4].beskrivelse).isEqualTo(dokumenttype)

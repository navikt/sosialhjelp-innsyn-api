...
enum class HendelseTekstType {
    ...
    KAN_IKKE_VISE_STATUS_SOKNAD_MED_TITTEL,
    KAN_IKKE_VISE_STATUS_SOKNAD_UTEN_TITTEL,
    ...
    KAN_IKKE_VISE_STATUS_SAK_MED_TITTEL,
    KAN_IKKE_VISE_STATUS_SAK_UTEN_TITTEL,
    SOKNAD_UNDER_BEHANDLING_MED_TITTEL,
    SOKNAD_UNDER_BEHANDLING_UTEN_TITTEL,
    SOKNAD_MOTTATT_HOS_KOMMUNE,
    SOKNAD_MOTTATT_UTEN_KOMMUNENAVN,
    SOKNAD_FERDIGBEHANDLET_MED_TITTEL,
    SOKNAD_FERDIGBEHANDLET_UTEN_TITTEL,

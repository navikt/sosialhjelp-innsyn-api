...
import no.nav.sbl.sosialhjelpinnsynapi.utils.IntegrationUtils.X_B3_FLAGS
import no.nav.sbl.sosialhjelpinnsynapi.utils.IntegrationUtils.X_B3_PARENTSPANID
import no.nav.sbl.sosialhjelpinnsynapi.utils.IntegrationUtils.X_B3_SAMPLED
import no.nav.sbl.sosialhjelpinnsynapi.utils.IntegrationUtils.X_B3_SPANID
import no.nav.sbl.sosialhjelpinnsynapi.utils.IntegrationUtils.X_B3_TRACEID
import no.nav.sbl.sosialhjelpinnsynapi.utils.IntegrationUtils.X_OT_SPAN_CONTEXT
import no.nav.sbl.sosialhjelpinnsynapi.utils.IntegrationUtils.X_REQUEST_ID

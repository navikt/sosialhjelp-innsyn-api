...
class DigisosApiController(private val digisosApiService: DigisosApiService,
    ...
    fun oppdaterDigisosSak(fiksDigisosId: String?, @RequestBody body: String): ResponseEntity<String> {
        val at = objectMapper.readTree(body).at("/sak/soker")
        val writeValueAsString = objectMapper.writeValueAsString(at)
        JsonSosialhjelpValidator.ensureValidInnsyn(writeValueAsString)

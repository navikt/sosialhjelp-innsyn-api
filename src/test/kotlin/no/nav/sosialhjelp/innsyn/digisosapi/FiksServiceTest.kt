...
internal class FiksServiceTest {
    ...
    fun init() {
        ...
        fiksService = FiksService(tilgangskontroll, fiksClient, kommuneService)
    }
    ...
    fun `GET alle DigisosSaker should populate cache for individual items`() =
        runTest(timeout = 5.seconds) {
            ...
            val fiksServiceWithCache = FiksService(tilgangskontroll, fiksClientWithCache, kommuneService)

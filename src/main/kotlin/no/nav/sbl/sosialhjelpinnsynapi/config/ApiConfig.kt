...
class WebSecurityConfig : WebSecurityConfigurerAdapter() {
    ...
    fun corsConfigurationSource(): CorsConfigurationSource {
        ...
        configuration.allowedHeaders = listOf("Origin", "Content-Type", "Accept", "X-XSRF-TOKEN", "Authorization", "Nav-Call-Id", "x-request-id", "x-client-trace-id", "x-b3-traceid", "x-b3-spanid", "x-b3-parentspanid", "x-b3-sampled", "x-b3-flags")

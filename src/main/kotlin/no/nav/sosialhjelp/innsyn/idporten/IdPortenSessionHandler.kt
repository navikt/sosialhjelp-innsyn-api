...
class IdPortenSessionHandler(
    ...
    fun clearSession(sid: String) {
        val loginId = redisService.get("$SESSION_ID_CACHE_PREFIX$sid", String::class.java) as? String
        if (loginId != null) {
            clearTokens(loginId)
    ...
    fun getToken(request: HttpServletRequest): String? {
        ...
        if (loginId != null) {
            val accessToken = redisService.get("$ACCESS_TOKEN_CACHE_PREFIX$loginId", String::class.java) as String?

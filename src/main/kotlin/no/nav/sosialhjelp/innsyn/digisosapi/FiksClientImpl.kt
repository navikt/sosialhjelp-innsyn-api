...
fun FilForOpplasting.toHttpEntity(
    name: String,
): HttpEntity<Any> {
    return InputStreamResource(this.fil).toHttpEntity(name, this.filnavn, "application/octet-stream")
}

fun FilOpplasting.toHttpEntity(
    name: String,
): HttpEntity<Any> {
    return InputStreamResource(this.data).toHttpEntity(name, this.metadata.filnavn, "application/octet-stream")
}

fun String.toHttpEntity(
    name: String,
): HttpEntity<Any> {

...
val SOKNADS_STATUS_BEHANDLES_IKKE: JsonSoknadsStatus = JsonSoknadsStatus()
    .withType(JsonHendelse.Type.SOKNADS_STATUS)
...
val UTBETALING_BANKOVERFORING: JsonUtbetaling = JsonUtbetaling()
    .withType(JsonHendelse.Type.UTBETALING)
    .withUtbetalingsreferanse(utbetaling_ref_1)
    .withSaksreferanse(referanse_1)
    .withRammevedtaksreferanse(null)
...
val UTBETALING_BANKOVERFORING_ANNEN_MOTTAKER: JsonUtbetaling = JsonUtbetaling()
    .withType(JsonHendelse.Type.UTBETALING)
    .withUtbetalingsreferanse(utbetaling_ref_1)
    .withSaksreferanse(referanse_1)
    .withRammevedtaksreferanse(null)

...
class CORSFilter : Filter {
    ...
    override fun doFilter(servletRequest: ServletRequest, servletResponse: ServletResponse, filterChain: FilterChain) {
        ...
        if (!isRunningInProd() && ALLOWED_ORIGINS.contains(origin)) {
            ...
            httpResponse.setHeader("Access-Control-Allow-Headers", "Origin, Content-Type, Accept, X-XSRF-TOKEN, XSRF-TOKEN-INNSYN-API, sosialhjelp-innsyn-id, Authorization, Nav-Call-Id")

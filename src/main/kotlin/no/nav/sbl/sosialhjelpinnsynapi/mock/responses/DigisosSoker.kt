        ...
        .withHendelser(
                listOf(
                                ...
                                .withDokumenter(
                                        listOf(
                                                ...
                                                JsonDokumenter()
                                                        ...
                                                        .withInnsendelsesfrist("2018-10-30T07:37:30.000Z")
                                        )
                                ),
                        ...
                        JsonUtbetaling()
                                ...
                                .withHendelsestidspunkt("2020-01-12T13:37:00.134Z")
                                ...
                                .withUtbetalingsdato("2020-01-01")
                        ...
                        JsonUtbetaling()
                                .withType(JsonHendelse.Type.UTBETALING)
                                .withHendelsestidspunkt("2020-01-13T13:37:00.134Z")
                                .withUtbetalingsreferanse("Betaling 2")
                                .withSaksreferanse("SAK1")
                                .withStatus(JsonUtbetaling.Status.UTBETALT)
                                .withBeskrivelse("Utbetaling til søker")
                                .withUtbetalingsdato("2020-01-20")
                                .withForfallsdato(null)
                                .withBelop(1234.0)
                                .withFom("2020-01-01")
                                .withTom("2020-01-31")
                        ...
                        JsonUtbetaling()
                                ...
                                .withSaksreferanse("SAK1")
                                .withStatus(JsonUtbetaling.Status.UTBETALT)
                                .withBeskrivelse("Utbetaling til søker i sept")
                                .withUtbetalingsdato("2020-01-11")
                                .withForfallsdato(null)
                                .withBelop(4200.0)
                                .withFom("2020-01-01")
                                .withTom("2020-01-31")
